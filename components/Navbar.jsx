        ...
        <div className="items-center hidden lg:flex gap-4">
          ...
          <div className="flex items-center bg-gray-100 p-1 rounded-full border border-gray-200/60 relative">
            <button
              ...
              className={`relative px-3.5 py-1.5 text-xs font-semibold rounded-full transition-colors duration-200 z-10 uppercase tracking-wider flex items-center gap-1.5 ${
          ...
          >
            <div className="flex flex-col gap-3">
              ...
              <div className="bg-gray-50 p-3 rounded-2xl border border-gray-100 mb-2 flex items-center justify-between">
                <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Operating Zone</span>
              ...
              <div className="pt-2 border-t border-gray-50">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`w-full hover:text-white bg-[#fbb817] ${theme.hoverBg} py-3 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 shadow-xs transition-colors`}
                >
