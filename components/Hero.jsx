...
const BACKGROUND_IMAGES = ["/Background/keralaBg.png"];
...
export default function TaxiBookingHero() {
  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center pt-32 pb-16 px-4 md:px-8 lg:px-16 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-green-900/90 via-black/40 to-green-800/50" />
        ...
        <div className="lg:col-span-5 flex flex-col justify-center space-y-4">
          <h1 className="text-4xl md:text-5xl font-bold uppercase tracking-tight text-white leading-tight">
            ...
            <span className={theme.textColor}>
              {fares.stateName} Premium Cabs
            </span>
          </h1>
          <p className="text-gray-200 md:text-lg max-w-xl">
            Reliable one way drops, local packages, outstation trips, and airport transfers across{" "}
          ...
          <form onSubmit={handleBookingSubmit} className="bg-white text-gray-800 w-full max-w-2xl rounded-3xl p-6 shadow-2xl flex flex-col border border-gray-100">
            <div className="mb-4">
              ...
              <p className="text-xs text-gray-400 mt-0.5 font-medium">
                Tailored Fleet Configuration Settings for {fares.stateName} Region
              </p>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <span className="text-[10px] opacity-70 font-normal mt-0.5">
                      Min charged: {activeVehicleObject?.pricing?.minKm || 50} KM
                    </span>
                  </button>
                  <button
                    type="button"
              ...
              <div>
                <span className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-2">3. Allocated Fleet Matrix</span>
                <Swiper
                  ref={swiperRef}
                  spaceBetween={8}
                  slidesPerView={2.4}
                  ...
                  {currentFleet.map((vehicle) => (
                    <SwiperSlide key={vehicle.id}>
                      <div
                        ...
                        style={{ color: selectedVehicle === vehicle.id ? theme.textColor.replace("text-[", "").replace("]", "") : undefined }}
                      >
                        ...
                        <div className="w-full mt-0.5">
                          <div className={`text-[10px] font-bold leading-none ${theme.textColor}`}>
                            {fares.currency}{vehicle.pricing?.perKm}/KM
                          </div>
            ...
            <button
              ...
              style={{ backgroundColor: theme.textColor.includes("[") ? theme.textColor.match(/\[(.*?)\]/)?.[1] : undefined }}
            >
